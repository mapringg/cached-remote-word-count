...
describe('GET wc?target=https://https://stackoverflow.com', () => {
  ...
  it('server should be able to support concurrency of up to 5 users and serve cache data after the data of the first user have been stored', async () => {
    ...
    console.log(firstUserRes.header['cache-data'])
    console.log(secondUserRes.header['cache-data'])
    // console.log(thirdUserRes.header['cache-data'])
    // console.log(fourthUserRes.header['cache-data'])
    // console.log(fifthUserRes.header['cache-data'])
  })
})

// describe('GET /wc?target=https://www.ubuntu.com', () => {
//   const url = '/wc'
//   const target = 'https://www.ubuntu.com'
